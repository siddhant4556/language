...
If $T\,\,<:\,\,\code{num}$ and not $T\,\,<:\,\,\code{Never}$, then:
\begin{itemize}
  \item{} If $\code{int}\,\,<:\,\,C$ and not $\code{num}\,\,<:\,\,C$,
      and $T\,\,<:\,\,\code{int}$
      then the context type of $e_2$ is \code{int}.
  \item{} If $\code{double}\,\,<:\,\,C$ and not $\code{num}\,\,<:\,\,C$,
      and not $T\,\,<:\,\,\code{double}$
...
If $T\,\,<:\,\,\code{num}$ and not $T\,\,<:\,\,\code{Never}$
...
\begin{itemize}
  ...
  \item{} Otherwise, if $S\,\,<:\,\,\code{double}$
    and not $S\,\,<:\,\,\code{Never}$,
    then the static type of $i$ is \code{double}.
  \item{} Otherwise, if $T\,\,<:\,\,\code{int}$,
    $S\,\,<:\,\,\code{int}$ and not $S\,\,<:\,\,\code{Never}$,
...
where $T\,\,<:\,\,\code{num}$ and not $T\,\,<:\,\,\code{Never}$,
then let $C$ be the context type of $i$.
\begin{itemize}
  \item{} If $T\,\,<:\,\,\code{int}$,
    $\code{int}\,\,<:\,\,S$ and not $\code{num}\,\,<:\,\,S$,
    then the context type of $e_2$ and $e_3$ is \code{int}.
  \item{} If $T\,\,<:\,\,\code{double}$,
    $\code{double}\,\,<:\,\,S$ and not $\code{num}\,\,<:\,\,S$,
